/*
Dot Calculator
You have to write a calculator that receives strings for input. The dots will 
represent the number in the equation. There will be dots on one side, an 
operator, and dots again after the operator. The dots and the operator will be 
...
function dotCalculator(equation) {
  ...
  const a = elements[0].length,
    b = elements[2].length;
  const result = Math.floor(operators[elements[1]](a, b));
